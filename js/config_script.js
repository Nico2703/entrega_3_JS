...
contenedor.innerHTML = `<h2> Listado de productos disponibles </h2>
                        ...
                        <button style="margin: 80px 20px; padding: 20px;" onclick="localStorage.clear(); sessionStorage.clear();"> Reset "local/session" storage</button>`
contenedor.style.width = '40%';
contenedor.addEventListener('mouseover', () => {
    contenedor.style.border = '1px solid cadetblue';
